...
Expense tracking as physical receipts. Same app, three homes. One oak box, many piles. If it is an expense, it is a thermal paper slip.
...
Kraft, gingham, thermal slips.

- **the drawer** — [drawer.html](https://rayzorzrb.github.io/ava-receipts/drawer.html)
- **drop** — [drop.html](https://rayzorzrb.github.io/ava-receipts/drop.html)
- **sort** — [sort.html](https://rayzorzrb.github.io/ava-receipts/sort.html)

Pure HTML/CSS/JS. Served from `main` `/` on GitHub Pages.

  ...
  function miniTile(c) {
    ...
    btn.innerHTML =
      '<div class="drawer mini">' +
        ...
        '<div class="well"></div>' +
        '<img class="lip" src="assets/3d/tray-lip.webp" width="900" height="759" alt="">' +
      "</div>" +
